 ...
 * @details
 * Defines the NVIC (Nested Vectored Interrupt Controller) registers.
 * The NVIC manages all interrupts on the ARM Cortex-M4 processor.
 *
 * The S32K144 features:
 ...
 * @version 1.0
 *
 * @note    Refer to the ARM Cortex-M4 Generic User Guide for details
 * @warning Use caution when modifying priorities or enabling/disabling interrupts
 */
